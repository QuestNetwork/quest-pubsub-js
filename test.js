...
async function publicChannelMessage(testMessage){
  ...
  console.log(GlobalPubSub.getChannelParticipantList([channel])['cList']);
  if(msgData['type'] == 'CHANNEL_MESSAGE' && GlobalPubSub.isParticipant(channel, msgData['channelPubKey']) && signatureVerified){
